...
export const Home: React.FC<NavigationProps> = ({ setPage }) => {
  return (
    <div className="animate-fade-in text-center pt-8">
      ...
      {/* Mission Text */}
      <div className="mb-10">
        <h1 className="text-3xl md:text-6xl font-bold mb-6 text-blue-400 font-heading leading-tight">
            Our mission is simple.
        </h1>
        
        <h2 className="text-2xl md:text-4xl font-light mb-10 text-white/90">
            To bring the Truth of Jesus Christ to the world!
        </h2>

        <p className="text-lg md:text-2xl leading-relaxed text-white/90 max-w-4xl mx-auto px-4">
      ...
      {/* Who We Are Button */}
      <div className="mb-16">
          <button onClick={() => setPage(Page.AboutUs)} className="bg-blue-600 text-white font-bold py-3 px-8 rounded-full shadow-lg hover:bg-blue-500 active:scale-95 transition-all uppercase tracking-widest font-heading">
              Who we are
          </button>
      </div>
      ...
      {/* Broadcast Section */}
      <div className="mb-24 px-4 relative overflow-hidden rounded-3xl group">
          <div 
          ...
          <div className="relative z-10 py-16 px-6">
              <div className="flex flex-col items-center justify-center gap-4 mb-8">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-white uppercase tracking-wider font-heading text-shadow-strong">Watch our archived broadcasts!</h3>
              </div>
              <button 
                onClick={() => window.open('https://m.youtube.com/channel/UCHUgOJkBGl1760u1fxAFvyA', '_blank', 'noopener,noreferrer')} 
                className="liquid-glass text-white font-bold py-4 px-12 rounded-full shadow-[0_0_25px_rgba(168,85,247,0.7)] hover:shadow-[0_0_35px_rgba(168,85,247,0.9)] border border-purple-500/50 hover:bg-white/10 active:scale-95 transition-all uppercase tracking-widest font-heading"
              >
                  Watch Now
              </button>
          </div>
