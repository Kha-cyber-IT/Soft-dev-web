...
export const ActionPages: React.FC<ActionPageProps> = ({ page, setPage }) => {
        ...
        <div className="text-center space-y-12">
            <div className="relative w-full aspect-[2/1] rounded-2xl overflow-hidden shadow-2xl border border-white/10 group cursor-pointer" onClick={() => window.open('https://maps.app.goo.gl/Q9CmxXAhxE1ypid59', '_blank')}>
                ...
                <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center p-4">
                    ...
                    <p className="text-gray-200 mt-2 font-medium">Click to open in Google Maps</p>
                </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <TimeCard day="Sunday" times={[
                    "Adult Bible Study & Children's Sunday School | 9:00 AM",
                    "Morning Worship Service | 10:00 AM",
                    "Evening Worship Service | 5:00 PM"
                ]} />
                <TimeCard day="Wednesdays" times={["Midweek Worship Services | 7:00 PM"]} />
                <TimeCard day="Fridays" times={["One80 Concept | 7:00 PM"]} />
            </div>
  ...
  // PAGE 8: CONFERENCE 2025
  if (page === Page.Conference2025) {
    return (
      <div className="animate-fade-in text-left text-white/90 pb-20 px-4">
        <BackButton label="Back to Mission" target={Page.Home} />
    ...
    return (
      <div className="animate-fade-in text-left text-white/90 pb-20">
        ...
        <div className="text-center mb-10">
            <h3 className="inline-block bg-teal-600 text-white text-xl font-bold py-3 px-8 rounded-full shadow-lg border border-white/20 uppercase tracking-widest font-heading">
                Not The Same: Testimonies of Lives Changed
            </h3>
        </div>

        <div className="space-y-8 text-center px-4 max-w-3xl mx-auto mb-16">
            <p className="text-xl text-gray-200 leading-relaxed">Jesus isn't just about church, He's about changing lives. The Potter's House is a family of believers built out of lives that used to be broken, but have been changed by the power of Jesus Christ. We are Not the Same.</p>
            <p className="text-xl text-gray-200 leading-relaxed font-bold text-blue-300">Follow Not The Same to hear a new testimony each Wednesday.</p>
        ...
        <div className="mb-20">
            ...
            <div className="text-center px-4">
                ...
                <div className="glass-card-blue p-8 rounded-2xl shadow-md max-w-2xl mx-auto mb-10">
                    <p className="text-xl text-white font-medium">Every Saturday, we send groups into the city to share the gospel to people in apartment complexes, neighborhoods, and shopping centers.</p>
                </div>
                
                <div className="mb-10 bg-teal-600 inline-block px-10 py-3 rounded-xl shadow-lg border border-teal-500">
                    <p className="text-2xl font-black text-white uppercase tracking-widest font-heading">Join us next Saturday at 10:00 AM!</p>
                </div>
                
                <div className="flex justify-center">
                   <button onClick={() => setPage(Page.StatementOfFaith)} className="bg-blue-600 text-white font-bold py-4 px-12 rounded-2xl shadow-lg border border-blue-400 hover:bg-blue-500 active:scale-95 transition-all uppercase tracking-widest font-heading">
                       Statement of Faith
                   </button>
                </div>
            </div>
      ...
      <div className="animate-fade-in text-left text-white/90 pb-20 px-4">
        ...
        <div className="space-y-12">
            ...
            <div className="pt-20 border-t border-white/10 text-center">
                ...
                <div className="glass-card-blue p-10 rounded-3xl max-w-4xl mx-auto border-dashed border-teal-500/50">
                    <Calendar className="h-16 w-16 text-teal-400 mx-auto mb-6" />
                    <p className="text-xl text-white/70 italic">The specific Eldorado Park yearly calendar will be displayed here soon.</p>
                </div>
            </div>
        </div>
      </div>
    ...
    return (
      <div className="animate-fade-in text-left text-white/90 pb-20">
         ...
         <div className="flex justify-center mb-12">
             <div className="glass-card-blue p-8 rounded-3xl max-w-3xl w-full text-center">
                 <h3 className="text-3xl font-bold text-white mb-3 uppercase tracking-widest font-heading">Explore our ministries.</h3>
                 <p className="text-xl text-white/80 font-light">Find ways you and your family can grow and make impact</p>
             </div>
         </div>
  ...
  // PAGE 15: CHILDRENS MINISTRY
  if (page === Page.ChildrensMinistry) {
    return (
      <div className="animate-fade-in text-left text-white/90 pb-20">
        <BackButton label="Back to Ministries" target={Page.Ministries} />
        
        <div className="relative w-full aspect-[2/1] rounded-2xl overflow-hidden mb-12 shadow-2xl border border-white/10">
            <img src="https://i.postimg.cc/BtWp06Sx/1dfbf742442f400382671b5fe13afd99.jpg" alt="Children's Ministry" className="absolute inset-0 w-full h-full object-cover opacity-90" />
            <div className="absolute inset-0 flex items-center justify-center p-4 bg-black/20">
                <h3 className="text-white text-3xl md:text-5xl font-black text-shadow-strong uppercase tracking-widest font-heading">Children's Ministry</h3>
            </div>
        </div>

        <div className="glass-card-blue p-10 rounded-3xl shadow-2xl mb-16 text-center max-w-4xl mx-auto">
            <h3 className="text-2xl md:text-3xl font-bold bg-teal-600 text-white px-8 py-3 inline-block rounded-xl mb-10 border border-teal-500 font-heading">Our children's ministry has something for every child!</h3>
            <h4 className="text-2xl font-bold text-blue-300 mb-4 uppercase tracking-widest font-heading">Sunday School</h4>
        ...
        <div className="text-center mb-12">
            <h4 className="text-3xl font-black text-blue-300 mb-8 uppercase tracking-widest font-heading">Recovery Ministry Program</h4>
            
            <div className="relative w-full aspect-[2/1] rounded-2xl overflow-hidden mb-10 shadow-2xl border border-white/10 group cursor-pointer" onClick={() => setPage(Page.Recovery)}>
                <img src="https://i.postimg.cc/3J1Jz929/4432a4c385c44e609ac41982225b1669.jpg" alt="Recovery" className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform" />
                <div className="absolute inset-0 flex items-center justify-center p-4 bg-black/30">
                    <h3 className="text-white text-2xl md:text-5xl font-black text-shadow-strong text-center uppercase tracking-widest font-heading">Explore Recovery</h3>
                </div>
            </div>
        </div>
      </div>
  ...
  if (page === Page.Recovery) {
    return (
      <div className="animate-fade-in text-left text-white/90 pb-20">
        ...
        <div className="relative w-full aspect-[2/1] rounded-2xl overflow-hidden mb-12 shadow-2xl border border-white/10">
            <img src="https://i.postimg.cc/3J1Jz929/4432a4c385c44e609ac41982225b1669.jpg" alt="Recovery Header" className="absolute inset-0 w-full h-full object-cover opacity-90" />
            <div className="absolute inset-0 flex items-center justify-center p-4 bg-black/20">
                <h3 className="text-white text-3xl md:text-5xl font-black text-shadow-strong text-center uppercase tracking-widest font-heading">Choose To Change</h3>
            </div>
        </div>
        ...
        <div className="text-center mb-12">
            ...
            <div className="glass-card-blue p-10 rounded-3xl max-w-3xl mx-auto space-y-8 text-xl leading-relaxed">
                <div className="bg-teal-600 p-4 rounded-xl mb-4 border border-teal-500 shadow-xl inline-block">
                    <ShieldCheck className="h-12 w-12 text-white" />
                </div>
                <p className="text-blue-400 font-bold text-2xl font-heading">It starts with a choice.</p>
